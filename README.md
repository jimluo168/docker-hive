...
This is a docker container for Apache Hive 2.3.3. It is based on https://github.com/big-data-europe/docker-hadoop so check there for Hadoop configurations.
